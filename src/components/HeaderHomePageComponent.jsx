        ...
        <div className=" p-2   bg-[#032758] md:bg-inherit ">
            <div className="container mx-auto pt-0 md:pt-8">
                <nav className="mx-11 2xl:mx-48  md:flex justify-between items-center my-1.5 md:my-10 h-14 static md:relative ">
                    ...
                    <ul className={`text-[13px] xl:text-[15px]  list-none gap-x-3 uppercase ${!isMenuOpen ? "xl:flex hidden" : "xl:flex block xl:static absolute right-0 top-20 xl:bg-inherit bg-[#032758] xl:text-black text-white xl:w-[auto] md:w-[300px] w-[100%] xl:px-0 px-6"} `}>
